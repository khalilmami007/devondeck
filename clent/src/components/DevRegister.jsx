...
const Register = (props) => {
    ...
    const handleconPwd = (e) => {
        ...
        if (e.target.value !== password) { setconpwdError("check your password confirmation!"); }
        else {
            setconpwdError("");
        }
    }
    const onSubmitHandler = (e) => {
        e.preventDefault();
        axios.post('http://localhost:5000/api/devs/register', {
            ...
            .then(res => {
                ...
                if (res && res.data) { console.log(" zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz", res.data.developer); }
